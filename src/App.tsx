...
// ============================================================
const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxsLgd1diUlfB5VOLh02O8zZzxGvkw0bJCyaIE7lFNG9oGES7HEptGEzTtnPPP0UWQf/exec";
  ...
  <div className="mb-4">
    ...
    <div className="relative">
      <input
        ...
        className={`w-full bg-gray-900/50 border rounded-xl px-4 py-3 text-white placeholder-gray-500 transition-all focus:ring-2 focus:ring-amber-500 outline-none ${
    ...
    <div className="mb-6">
      ...
      {photo.preview ? (
        ...
        <div 
          ...
          className={`border-2 border-dashed rounded-2xl p-8 text-center cursor-pointer transition-all hover:bg-amber-500/5 ${
            error ? "border-red-500 bg-red-500/5" : "border-gray-700 hover:border-amber-500/50"
          }`}
        >
...
export default function App() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const payload = {
        ...form,
        evento: "Campeonato Regional Matagalpa 2026",
        fotoSelfie: {
    ...
    <div className="min-h-screen bg-gray-950 text-white font-sans selection:bg-amber-500/30">
      ...
      <header className="relative pt-12 pb-8 px-4 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-black tracking-tight mb-2">
          CAMPEONATO <span className="text-amber-500">REGIONAL</span>
        </h1>
        <p className="text-amber-200/60 font-bold tracking-[0.5em] uppercase text-sm">Matagalpa 2026</p>
      </header>
      ...
      <main className="relative max-w-4xl mx-auto px-4 pb-20">
          ...
          {PASOS.map((p, i) => (
            <div key={i} className="flex flex-col items-center flex-1 relative">
              ...
              <span className={`text-[10px] mt-2 font-bold uppercase tracking-wider hidden md:block ${
                i <= step ? "text-amber-500" : "text-gray-600"
              }`}>{p.title}</span>
              {i < PASOS.length - 1 && (
                <div className={`absolute top-5 left-[60%] w-[80%] h-[2px] -z-10 ${
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="mb-8">
                <button
                  ...
                  className={`w-full p-4 rounded-2xl border flex items-center gap-4 transition-all ${
                    form.atletaLibre ? "bg-amber-500/10 border-amber-500" : "bg-gray-900/50 border-gray-700"
                  }`}
                >
                  <div className={`w-6 h-6 rounded-md border-2 flex items-center justify-center ${
                    form.atletaLibre ? "bg-amber-500 border-amber-500" : "border-gray-500"
                  }`}>
              ...
              <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-4 mt-4 flex gap-4">
                 ...
                 <p className="text-amber-200/70 text-xs leading-relaxed">
                   El pesaje oficial será de 12:00 PM a 3:00 PM en el Centro Cultural Héroes y Mártires. 
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { id: "aceptaHorario", text: "Confirmo que el pesaje es de 12:00 PM a 3:00 PM y seré puntual." },
                  { id: "autorizaDatos", text: "Autorizo el uso de mi imagen y datos para fines del evento." }
                ].map((item) => (
                  <label 
                    key={item.id}
                    className={`flex items-start gap-4 p-4 rounded-2xl border cursor-pointer transition-all ${
                      (form as any)[item.id] ? "bg-amber-500/10 border-amber-500" : "bg-gray-900/50 border-gray-700"
                    }`}
                  >
                    <input 
                      type="checkbox" 
              ...
              {(errors.aceptaReglamento || errors.aceptaHorario) && (
                <p className="text-red-400 text-xs mt-2">Debe aceptar los términos para continuar.</p>
              )}
            </div>
          )}
        ...
        <footer className="mt-12 text-center text-gray-600 text-xs">
           <p className="mb-2">Federación Nicaragüense de Fisicoculturismo • Matagalpa 2026</p>
